object frmTest: TfrmTest
  ...
  object pcMain: TPageControl
    ...
    object tseFatura: TTabSheet
      Caption = 'e-Fatura / e-Ar'#351'iv'
      ImageIndex = 1
      object pcFatura: TPageControl
        Left = 0
        Top = 0
        Width = 738
        Height = 511
        ...
        object tsHtml: TTabSheet
          ...
          object wbHtml: TWebBrowser
            ...
            ExplicitHeight = 150
            ControlData = {
              4C000000734B0000822E00000000000000000000000000000000000000000000
    ...
    object TabSheet1: TTabSheet
      ...
      ImageIndex = 2
      object pceIrsaliye: TPageControl
        Left = 0
        Top = 0
        Width = 738
        Height = 511
        ActivePage = tsIrsaliyeYarat
        Align = alClient
        TabOrder = 0
        object tsIrsaliyeYarat: TTabSheet
          Caption = 'tsIrsaliyeYarat'
        end
      end
    end
  end
  object Panel6: TPanel
    ...
    DesignSize = (
      746
      41)
    object btnIrsaliyeKaydet: TButton
      Left = 655
      Top = 7
      Width = 75
      Height = 25
      ...
      Caption = 'Kaydet'
      TabOrder = 0
      OnClick = btnIrsaliyeKaydetClick
    end
  end
